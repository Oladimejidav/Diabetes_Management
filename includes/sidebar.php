        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#" style="padding-top: 20%;">
                <!--<div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-virus"></i>
                </div>-->
                <div class="sidebar-brand-text mx-3" >Ontology Diabetes Management</div>
            </a>

            <!-- Divider --><br>
            <hr class="sidebar-divider my-0" style="padding-top: 10%">
<?php if($_SESSION['aid']):?>
     ...
     <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="all-test">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Blood Glocose Level Event</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="assigned-test.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Medication Event</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="ontheway-samplecollection-test">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Diet Event</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="sample-collected-test">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Mood Event</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="samplesent-lab-test">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Other Event</span></a>
            </li>
<!--
    <li class="nav-item">
